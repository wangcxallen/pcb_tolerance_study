...
def main():
    print('Start');
    get_data = get_tolerance_data('tol_data_50',50)
...
class get_tolerance_data:
    ...
    def get_2d_tolerance(self, res_theta=1000):
        ...
        num_col = 20 #np.random.randint(2,21)
        xp_p_frame = 2.5 * np.array( num_row * [i for i in np.arange(num_col)] )
        ...
        theta = np.linspace(0,3.1415,res_theta)
        ...
        tolerance_2d = (tolerance_2d) * (3.1415/res_theta)
        return tolerance_2d
